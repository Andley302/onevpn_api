...
sleep 5;
clear;
wget https://raw.githubusercontent.com/Andley302/onevpn_api/main/badvpn/badvpnx-files/antcrashudp.sh -O /bin/antcrashudp.sh > /dev/null 2>&1
chmod +x /bin/antcrashudp.sh;
wget https://raw.githubusercontent.com/Andley302/onevpn_api/main/badvpn/badvpnx-files/badvpn-udpgw -O /bin/badvpn-udpgw > /dev/null 2>&1
